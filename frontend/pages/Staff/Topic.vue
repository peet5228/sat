                    ...
                    <v-card-text>
                        <v-form @submit.prevent="saveMember">
                            <v-row>
                                ...
                                <v-row>
                                    <v-col cols="12" md="6">
                                        <v-btn class="text-white" type="submit" block color="blue">{{ form.id_topic ? 'อัปเดต' : 'บันทึก' }}</v-btn>
                                    </v-col>
                                    <v-col cols="12" md="6">
                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :keys="items.id_topic">
                                    ...
                                    <td class="text-center border">
                                        ...
                                        <v-btn class="text-white" color="error" @click="del(items.id_topic)" size="small">ลบ</v-btn>
                                    </td>
                                </tr>
