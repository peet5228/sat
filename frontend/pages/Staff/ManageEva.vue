    ...
    <v-container fluid class="py-10">
                <v-card>
                    <v-sheet class="pa-4 text-center" color="">
                        <h1 class="text-h5 font-weight-bold">จัดการผู้รับการประเมิลผล</h1>
                    </v-sheet>
                    <v-card-text>
                        <v-form @submit.prevent="saveMember">
                            <v-row>
                                ...
                                <v-row>
                                    <v-col cols="12" md="6">
                                        <v-btn class="text-white" type="submit" block color="blue">{{ form.id_member ? 'อัปเดต' : 'บันทึก' }}</v-btn>
                                    </v-col>
                                    <v-col cols="12" md="6">
                            ...
                            <tbody>
                                <tr v-for="(items,index) in filteredResult" :keys="items.id_member">
                                    ...
                                    <td class="text-center border">
                                        ...
                                        <v-btn class="text-white" color="error" @click="del(items.id_member)" size="small">ลบ</v-btn>
                                    </td>
                                </tr>
                            </tbody>
                        </v-table>
