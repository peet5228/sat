                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :keys="items.id_sys">
                                    ...
                                    <td class="text-center border">
                                        <v-btn v-if="items.status_commit === 'y'" class="text-white" color="success" size="small">ประเมินแล้ว</v-btn>
                                        <v-btn v-else class="text-white" color="blue" @click="go(items.id_eva)" size="small">ประเมิน</v-btn>
                                    </td>
                                </tr>
